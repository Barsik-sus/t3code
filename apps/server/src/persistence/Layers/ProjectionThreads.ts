...
import { ModelSelection, OrchestrationNativeAgent, ThreadOrigin } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.notifyMode},
          ${JSON.stringify(row.nativeAgents)},
          ${row.latestTurnId},
          ${row.createdAt},
          ${row.updatedAt},
          ${row.archivedAt},
          ${row.archivedCascadedFrom},
        ...
        DO UPDATE SET
          ...
          archived_cascaded_from = excluded.archived_cascaded_from,
