  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      const dispatchBootstrapTurnStart = (
        ...
        dispatchThreadTurnBootstrap({
          turnStartCommand: command,
          ...(command.bootstrap?.createThread
            ? {
                createThreadCommand: {
                  type: "thread.create",
                  commandId: CommandId.make(`server:bootstrap-thread-create:${command.commandId}`),
          ...
          ...(command.bootstrap?.prepareWorktree
            ...
            : {}),
          runSetupScript: command.bootstrap?.runSetupScript ?? false,
        }).pipe(
